      ...
      def add_payment_details(xml, money, currency_code, options = {})
        xml.tag! 'n2:PaymentDetails' do
          ...
          if [:subtotal, :shipping, :handling, :tax].all?{ |o| options.has_key?(o) }
            ...
            xml.tag! 'n2:ItemTotal', formatted_total(item_total, currency_code), 'currencyID' => currency_code
          ...
          xml.tag! 'n2:OrderTotal', formatted_total(order_total, currency_code), 'currencyID' => currency_code
